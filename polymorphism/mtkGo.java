...
public class mtkGo {
    public static void main(String[] args) {
        ...
        mtk.setPenjumlahan(23, 34);
        mtk.setPenjumlahan(12, 28, 14);
        mtk.setPenjumlahan(3.4, 4.9);
        mtk.setPenjumlahan(12.5, 28.7, 14.2);
        ...
        mtk.setModulus(34, 23);
        mtk.setModulus(4.9, 3.4);
    }
}
